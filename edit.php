<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE `students_details` SET `id`='$id',`roll_no`='$roll_no',`student_name`='$student_name',`branch`='$branch' WHERE id=$id";
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <?php 
                ...
                $sql = "SELECT * FROM `students_details` WHERE id=$id LIMIT 1";
